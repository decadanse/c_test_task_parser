...
public:
    ...
    Node(const std::string value, Node* left, Node* right) : value(value) , left(left), right(right)
    {
    }
...
public:
    ...
    const std::vector<std::string> left_brackets = { "(" }; //Other types of brackets can be added
